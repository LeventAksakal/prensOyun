<template>
  <main>
          ...
          <div class="grid">
            <div v-for="(row, rowIndex) in grid" :key="rowIndex" class="grid-row">
              ...
              >
                <div
                  v-if="
                    state.pong.isHost && game.shipIndices.includes(rowIndex * columns + colIndex)
                  "
                  class="shipSegment"
                ></div>
                <div
                  v-if="
                    state.pong.isGuest &&
                    game.shipIndicesEnemy.includes(rowIndex * columns + colIndex)
                  "
                  class="shipSegment"
                ></div>
              </div>
    ...
    <div
      v-if="
        (state.pong.isHost && !state.battleship.turn) ||
        (state.pong.isGuest && state.battleship.turn)
      "
      class="turnOverlay"
    >
    ...
    <div class="grid-container">
      ...
      <div class="grid">
        <div v-for="(row, rowIndex) in grid" :key="rowIndex" class="grid-row">
          ...
          >
            <div
              v-if="state.pong.isHost && game.shipIndices.includes(rowIndex * columns + colIndex)"
              class="shipSegment"
            ></div>
            <div
              v-if="
                state.pong.isGuest && game.shipIndicesEnemy.includes(rowIndex * columns + colIndex)
              "
              class="shipSegment"
            ></div>
            ...
            <div
              v-if="
                state.pong.isHost &&
                game.shipIndices.includes(rowIndex * columns + colIndex) &&
                state.battleship.hitsEnemy.includes(rowIndex * columns + colIndex)
              "
              class="redCircle"
            ></div>
            <div
              v-if="
                state.pong.isGuest &&
                game.shipIndicesEnemy.includes(rowIndex * columns + colIndex) &&
                state.battleship.hits.includes(rowIndex * columns + colIndex)
              "
              class="redCircle"
            ></div>
            <div
      ...
      <div class="grid-enemy">
        <div v-for="(rowEnemy, rowIndex) in gridEnemy" :key="rowIndex" class="grid-row-enemy">
          <div
            v-for="(column, colIndex) in rowEnemy"
            :key="colIndex"
            class="grid-cell-enemy"
            @click="handleCellClickEnemy(rowIndex, colIndex)"
            @mouseenter="handleMouseEnter(rowIndex, colIndex)"
            @mouseleave="handleMouseLeave(rowIndex, colIndex)"
          ...
          >
            <div
              v-if="
                state.pong.isHost &&
                redIndicesEnemy.includes(rowIndex * columns + colIndex) &&
                !state.battleship.shipIndicesEnemy.includes(rowIndex * columns + colIndex)
              "
              class="circle"
            ></div>
            ...
            <div
              v-if="
                state.pong.isGuest &&
                redIndicesEnemy.includes(rowIndex * columns + colIndex) &&
                !state.battleship.shipIndices.includes(rowIndex * columns + colIndex)
              "
              class="circle"
            ></div>
            <div
